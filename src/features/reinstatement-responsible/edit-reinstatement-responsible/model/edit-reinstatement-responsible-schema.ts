...
export const useEditReinstatementResponsibleDetailsFormSchema = () => {
...
export type EditReinstatementResponsibleDetailsFormSchema = z.infer<
  ReturnType<typeof useEditReinstatementResponsibleDetailsFormSchema>
>;
